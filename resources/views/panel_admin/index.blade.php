    ...
    <div class="d-flex w-100">
        ...
        <div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark border-end border-secondary"
            ...
            <ul class="nav nav-pills flex-column mb-auto" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link text-white w-100 text-start" data-bs-toggle="pill"
                        data-bs-target="#pantalla-usuarios-desactivados" type="button" role="tab">Usr. Desactivados</button>
                </li>
            </ul>
        </div>
        ...
        <div class="tab-content flex-grow-1 p-4 overflow-auto" id="v-pills-tabContent" style="max-height: calc(100vh - 60px);">
                        ...
                        <div class="col-12 col-md-4 col-lg-4">
                            <div class="card h-100 bg-dark text-white border-secondary shadow-sm">
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <div class="mt-auto d-flex gap-2">
                                        <form action="{{ route('usuarios.destroy', $users->id) }}" method="POST" class="w-100">
                                            @csrf
                                            @method('DELETE')
            ...
            {{-- 8. PANTALLA DE USUARIOS DESACTIVADOS --}}
                    ...
                    <div class="col-12 col-md-4 col-lg-4">
                        <div class="card h-100 bg-secondary text-white border-dark shadow-sm">
                            <div class="card-body d-flex flex-column">
                                ...
                                <div class="mt-auto d-flex gap-2">
                                    <form action="{{ route('usuarios.restore', $user->id) }}" method="POST" class="w-100">
                                        @csrf
                                        @method('PATCH')
                                        <button type="submit" class="btn btn-sm btn-success w-100 fw-bold" onclick="return confirm('¿Estás seguro de que deseas devolverle el acceso a este usuario?')">
