...
<h1 class="text-warning fw-bold">crear Producto</h1>

<form action="{{ route('panel_admin.store') }}" method="POST">
    ...
    <div class="row">
        <div class="col-md-6 offset-md-3 bg-dark p-4 rounded shadow-lg">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control bg-light text-dark border-secondary" name="nombre" placeholder="Colocar nombre del producto...">
            </div>
            <div class="mb-3">
                <label class="form-label text-warning fw-bold">Descripción</label>
                <textarea class="form-control bg-light text-dark border-secondary" name="descripcion" rows="3" placeholder="Colocar descripción detallada...">
...
<div class="mb-3">
    ...
    <input type="number" min="0" step="0.01" class="form-control bg-light text-dark border-secondary" name="precio" placeholder="Colocar precio...">
</div>


<div class="mb-3">
    <label class="form-label text-warning fw-bold">Stock</label>
    <input type="number" min="0" class="form-control bg-light text-dark border-secondary" name="stock"  placeholder="Colocar cantidad de stock...">
</div>
            
<div class="mb-3">
    <label class="form-label text-warning fw-bold">Ubicación de la Imagen</label>

    <input type="text" class="form-control bg-light text-dark border-secondary" name="imagen"  placeholder="Ej: Creatinas/Crea-500-star.jpg">
...
<div class="mb-4 form-check mt-3">
    <input type="checkbox" class="form-check-input bg-dark border-secondary" name="activo" value="1" id="checkActivo">
    <label class="form-check-label text-white" for="checkActivo">Activo (Visible en el catálogo)</label>
</div>

<div class="d-grid gap-3">
    <button type="submit" class="btn btn-warning fw-bold fs-5 btn-hover-shadow">Guardar Producto</button>
